...
import AdminBlogCollectionList from "../../component/BlogCollection/BlogCollectionList/AdminBlogCollectionList";
...
function AdminCategoryPage(){
    ...
    return(
        <AdminBlogCollectionList queryPageResult={queryPageResult} handlePageChange={handlePageChange}/>
    )
}
